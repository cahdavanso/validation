document.addEventListener('DOMContentLoaded', () => {
    ...
    const FIELDS_CONSIGFACIL = ["FRONT", "CONCILIACAO", "KOBRAKI", "ANDAMENTO", "AVERBADOS"];
    const FIELDS_CODATA = ["FRONT", "CONCILIACAO", "KOBRAKI", "ANDAMENTO", "AVERBADOS"];
    const FIELDS_INSS = ["FRONT", "CONCILIACAO", "KOBRAKI", "AVERBADOS", "CASOS_CAPITAL"];
    const FIELDS_SERHA = ["FRONT", "CONCILIACAO", "KOBRAKI", "AVERBADOS", "TRABALHADO_ANTERIOR", "COMPLEMENTAR", "ORBITAL"];
    const FIELDS_ZETRA = ["FRONT", "CONCILIACAO", "KOBRAKI", "ZIPS", "HISTORICO", "ORBITAL"];
    const FIELDS_CONSIGLOG = ["FRONT", "CONCILIACAO", "KOBRAKI", "AVERBADOS", "ORBITAL"];
