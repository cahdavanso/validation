document.addEventListener('DOMContentLoaded', () => {
    ...
    const FIELDS_CONSIGFACIL = ["FRONT", "FUNCAO", "CONCILIACAO", "KOBRAKI", "TACS", "EXTRA-JUDICIAL", "ANDAMENTO", "AVERBADOS", "ORBITAL"];
    const FIELDS_CODATA = ["FRONT", "FUNCAO", "CONCILIACAO", "KOBRAKI", "TACS", "EXTRA-JUDICIAL", "ANDAMENTO", "AVERBADOS", "ORBITAL"];
    const FIELDS_INSS = ["FRONT", "FUNCAO", "CONCILIACAO", "KOBRAKI", "TACS", "EXTRA-JUDICIAL", "AVERBADOS", "CASOS_CAPITAL", "ORBITAL", "D8"];
    const FIELDS_SERHA = ["FRONT", "FUNCAO", "CONCILIACAO", "KOBRAKI", "TACS", "EXTRA-JUDICIAL", "AVERBADOS", "TRABALHADO_ANTERIOR", "COMPLEMENTAR", "ORBITAL"];
    const FIELDS_ZETRA = ["FRONT", "FUNCAO", "CONCILIACAO", "KOBRAKI", "TACS", "EXTRA-JUDICIAL", "AVERBADOS", "HISTORICO", "ORBITAL"];
    const FIELDS_CONSIGLOG = ["FRONT", "FUNCAO", "CONCILIACAO", "KOBRAKI", "TACS", "EXTRA-JUDICIAL", "AVERBADOS", "ORBITAL"];
    const FIELDS_INFOCONSIG = ["FRONT", "FUNCAO", "CONCILIACAO", "KOBRAKI", "TACS", "EXTRA-JUDICIAL", "AVERBADOS", "ORBITAL"];
    const FIELDS_TO_IGEPREV = ["FRONT", "FUNCAO", "AVERBADOS_TO", "AVERBADOS_IGEPREV", "D8_TO", "D8_IGEPREV", "CONCILIACAO", "KOBRAKI", "TACS", "EXTRA-JUDICIAL"];
    const FIELDS_RF1 = ["FRONT", "FUNCAO", "AVERBADOS", "CONCILIACAO", "KOBRAKI", "TACS", "EXTRA-JUDICIAL"];
    const FIELDS_CIP = ["FRONT", "FUNCAO", "AVERBADOS", "CONCILIACAO", "KOBRAKI", "TACS", "EXTRA-JUDICIAL", "ORBITAL"];
    const FIELDS_SIGRH = ["FRONT", "FUNCAO", "AVERBADOS_SC_CAPITAL", "AVERBADOS_SC_CLICK", "ANDAMENTO_SC_CAPITAL", "ANDAMENTO_SC_CLICK", "CONCILIACAO", "KOBRAKI", "TACS", "EXTRA-JUDICIAL", "ORBITAL"];
    const FIELDS_CONSIG_KONEXIA = ["FRONT", "FUNCAO", "CONCILIACAO", "KOBRAKI", "TACS", "EXTRA-JUDICIAL", "AVERBADOS", "ORBITAL"];
    const FIELDS_NEOCONSIG = ["FRONT", "FUNCAO", "CONCILIACAO", "KOBRAKI", "TACS", "EXTRA-JUDICIAL", "AVERBADOS", "ORBITAL"];
    const FIELDS_QUANTUM = ["FRONT", "FUNCAO", "CONCILIACAO", "KOBRAKI", "TACS", "EXTRA-JUDICIAL", "AVERBADOS", "ORBITAL"];
