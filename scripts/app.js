document.addEventListener('DOMContentLoaded', () => {
    ...
    const FIELDS_INSS = ["FRONT", "FUNCAO", "CONCILIACAO", "KOBRAKI", "TACS", "AVERBADOS", "CASOS_CAPITAL", "ORBITAL", "D8"];
    const FIELDS_SERHA = ["FRONT", "FUNCAO", "CONCILIACAO", "KOBRAKI", "TACS", "AVERBADOS", "TRABALHADO_ANTERIOR", "COMPLEMENTAR", "ORBITAL"];
    const FIELDS_ZETRA = ["FRONT", "FUNCAO", "CONCILIACAO", "KOBRAKI", "TACS", "AVERBADOS", "HISTORICO", "ORBITAL"];
    const FIELDS_CONSIGLOG = ["FRONT", "FUNCAO", "CONCILIACAO", "KOBRAKI", "TACS", "AVERBADOS", "ORBITAL"];
