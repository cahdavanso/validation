    ...
    def credbase_trabalhado_func(self, cred):
        ...
        def refin():
            ...
            if self.convenio in ['GOV. MA', 'PREF. PAÇO DO LUMIAR', 'PREF. BAYEUX']:
                ...
                semi_cred_hp20['Parcela_temporaria'] = semi_cred_hp20['Parcela']
                semi_cred_hp20.loc[semi_cred_hp20['Banco'] == 'BANCO HP', 'Parcela_temporaria'] += 20

                # Criar CONCAT com +20
                semi_cred_hp20['CONCAT'] = semi_cred_hp20['CPF'].astype(str) + semi_cred_hp20['Parcela_temporaria'].astype(str)
                ...
                # Podemos retirar a coluna de parcela_temporaria
                semi_cred_hp20 = semi_cred_hp20.drop(columns=['Parcela_temporaria'])
                ...
                df_refina = casos_batidos[casos_batidos['Tipo'] == 'Refin']
                # df_refina = casos_batidos
            else:
                # CONCAT original (sem ajuste)
                semi_cred['CONCAT'] = semi_cred['CPF'].astype(str) + semi_cred['Parcela'].astype(str)
        ...
        if historico_refin is not None:
            ...
            nova_coluna_valor_lancar = credbase_trabalhado['Valor a lançar'].tolist() + historico_refin['Parcela'].tolist()
